...
public class Assets extends AssetManager {
    ...
    public Animation<TextureRegion> space, alien, aliendie, naveidle, naveleft, naveright, naveshoot, shoot ,alienshoot,weapong,gameover;
    ...
    void loadAnimations(){
        ...
        weapong = new Animation<TextureRegion>(0.1f, atlas.findRegions("weapong"));
        gameover = new Animation<TextureRegion>(0.1f, atlas.findRegions("gameover"));
    }
}
